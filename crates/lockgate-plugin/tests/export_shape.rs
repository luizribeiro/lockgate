...
const ASYNC_GUIDANCE: &str = "Async signatures are often generated by guest toolchains by default; the exported WIT function must be a synchronous value-returning function, but the host call may still be asynchronous.";
