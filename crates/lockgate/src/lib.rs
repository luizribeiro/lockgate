...
pub use lockgate_policy::{
    CapabilityContract, EnvVarName, HttpOrigin, InvalidPluginId, Permission, PluginId, Scope,
    ScopeError, ScopeRef, ScopeRepr, ScopedPermission, capability, check_scope_laws, env, net,
};
pub use policy::{
    CapabilityRegistrationError, ConsentManifest, ConsentRecord, ConsentRequired, DriftChange,
    DriftKind, DriftReport, EffectiveGrants, ExportDrift, ExportDriftKind, GrantReview,
...
#[doc(hidden)]
pub mod __private {
    pub use crate::exec::{HostParts, StoreCtx, catch_host_panic};
